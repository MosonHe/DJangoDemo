...
class UserInfo(models.Model):
    ...
    depart = models.ForeignKey(verbose_name='部门', to="Department", to_field="depart_id", default= 10, on_delete=models.SET_DEFAULT)
    # depart = models.OneToOneField(verbose_name='部门', to="Department", to_field="depart_id", default= 10, on_delete=models.SET_DEFAULT)
